...
const sequelize = new Sequelize(
  "postgres://default:KtBGTOeQ69bE@ep-tiny-star-a4ey3up7.us-east-1.aws.neon.tech:5432/verceldb?sslmode=require"
);
...
app.get("/cadastrar/:cheio", function (req, res) {
  Sensor.create({
    cheio: req.params.cheio
  })
    .then(function () {
